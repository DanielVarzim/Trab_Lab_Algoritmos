...
def get_genome_zone(start,stop,filename):
    ...
    Scripts = "C:\\Users\\Daniel Varzim\\Documents\\GitHub\\Trab_Lab_Algoritmos" +filename #source folder
    dst = "C:\\Users\\Daniel Varzim\\Documents\\GitHub\\Trab_Lab_Algoritmos\\res"            #destination folder
    shutil.move(Scripts, dst)
...
def parse_blast(filename):
    result_handle = open("C:\\Users\\Daniel Varzim\\Documents\\GitHub\\Trab_Lab_Algoritmos\\res"+filename)
